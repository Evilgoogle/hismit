...
window.$ = window.jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); // import Swiper from 'swiper/js/swiper';
// window.WOW = require('./wow');

 // require('./jquery.inputmask.bundle');
// Ширина и высота экрана

var $displayWidht = screen.width;
var $displayHeight = screen.height;
console.log("Ширина экрана: " + $displayWidht + " / Высота экрана: " + $displayHeight); // Ширина и высота браузера клиента

var $clientWidht = window.innerWidth;
var $clientHeight = window.innerHeight;
console.log("Ширина браузера: " + $clientWidht + " / Высота браузера: " + $clientHeight);
var $user_agent = navigator.userAgent.toLowerCase(); // detect the user agent

var $ios_devices = $user_agent.match(/(iphone|ipad)/) ? "touchstart" : "click"; //check ios devices
...
formRequest.submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      if (data.status == 'ok') {
        sweetalert2_dist_sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire({
          position: 'center',
          type: 'success',
          title: data.message,
...
function getYandexMap($this, ymaps) {
  ...
  $('#' + $id).empty();
  var latLng = [parseFloat($this.data('latitude')), parseFloat($this.data('longitude'))];
  var $icon_size = [50, 50];
...
__webpack_require__(/*! D:\Games\OSPanel_2\domains\w-test1.local\resources\assets\js\app.js */"./resources/assets/js/app.js");
__webpack_require__(/*! D:\Games\OSPanel_2\domains\w-test1.local\resources\assets\sass\app.scss */"./resources/assets/sass/app.scss");
module.exports = __webpack_require__(/*! D:\Games\OSPanel_2\domains\w-test1.local\resources\assets\sass\admin.scss */"./resources/assets/sass/admin.scss");
