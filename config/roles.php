...
return [
    ...
    */
    ...
    'defaultSeeds' => [
        'NewPermissionsTableSeeder'        => env('ROLES_SEED_DEFAULT_PERMISSIONS', true),
        'NewRolesTableSeeder'              => env('ROLES_SEED_DEFAULT_ROLES', true),
        'NewConnectRelationshipsSeeder'    => env('ROLES_SEED_DEFAULT_RELATIONSHIPS', true),
        'NewUsersTableSeeder'              => env('ROLES_SEED_DEFAULT_USERS', false),
    ],
